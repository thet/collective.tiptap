...
class TestSetup(unittest.TestCase):
    """Test that collective.tiptap is properly installed."""

    layer = COLLECTIVE_TIPTAP_INTEGRATION_TESTING
    ...
    def test_product_installed(self):
        """Test if collective.tiptap is installed."""
...
class TestUninstall(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.installer.uninstall_product("collective.tiptap")
        setRoles(self.portal, TEST_USER_ID, roles_before)

    def test_product_uninstalled(self):
        """Test if collective.tiptap is cleanly uninstalled."""
